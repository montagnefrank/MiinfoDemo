...
!function (e) {
    ...
    f.prototype = {
        ...
        maxFileSize: 0,
        maxFileCount: 0,
        msgSizeTooLarge: 'El Archivo "{name}" (<b>{size} KB</b>) es muy pesado (maximo  <b>{maxSize} KB</b>. ) Por favor intente con uno distinto!',
        msgFilesTooMany: "Usted intenta subir <b>({n})</b> archivos y solo puede subir <b>{m}</b>. !",
